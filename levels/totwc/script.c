...
#ifdef PORT_MOP_OBJS
    OBJECT(/*model*/ MODEL_TRAMPOLINE, /*pos*/   -800, -1900, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00AA0000, /*beh*/ bhvBetaTrampolineTop),
#endif
    RETURN(),
};
...
const LevelScript level_totwc_entry[] = {
    ...
    AREA(/*index*/ 1, totwc_geo_000188),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -4095, 2935, 0, /*angle*/ 0, 90, 0, /*behParam*/ BHV_PARAM_2(WARP_NODE_0A), /*beh*/ bhvFlyingWarp),
        WARP_NODE(/*id*/ WARP_NODE_0A,         /*destLevel*/ LEVEL_TOTWC,  /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_WARP_FLOOR, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_20, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_SUCCESS,    /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_26, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,      /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_23, /*flags*/ WARP_NO_CHECKPOINT),
