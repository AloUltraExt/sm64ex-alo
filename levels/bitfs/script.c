...
#ifdef PORT_MOP_OBJS
    OBJECT(/*model*/ MODEL_BLARGG, /*pos*/   7900, -3071, 266, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBlargg),
#endif
    RETURN(),
};
...
const LevelScript level_bitfs_entry[] = {
    ...
    AREA(/*index*/ 1, bitfs_geo_0007A0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -7577, -1764,  0, /*angle*/ 0, 90, 0, /*behParam*/ BHV_PARAM_2(WARP_NODE_0A), /*beh*/ bhvAirborneWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  6735,  3681, 99, /*angle*/ 0, 0, 0,  /*behParam*/ BHV_PARAM_1(20) | BHV_PARAM_2(WARP_NODE_0B), /*beh*/ bhvWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  5886,  5000, 99, /*angle*/ 0, 90, 0, /*behParam*/ BHV_PARAM_2(WARP_NODE_0C), /*beh*/ bhvDeathWarp),
        WARP_NODE(/*id*/ WARP_NODE_0A,    /*destLevel*/ LEVEL_BITFS,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_0B,    /*destLevel*/ LEVEL_BOWSER_2, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_0C,    /*destLevel*/ LEVEL_BITFS,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0C, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH, /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x03, /*destNode*/ WARP_NODE_68, /*flags*/ WARP_NO_CHECKPOINT),
