...
const LevelScript level_bowser_1_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 1307, 0, /*angle*/ 0, 180, 0, /*behParam*/ BHV_PARAM_2(WARP_NODE_0A), /*beh*/ bhvSpinAirborneCircleWarp),
        WARP_NODE(/*id*/ WARP_NODE_0A,      /*destLevel*/ LEVEL_BOWSER_1, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0A,  /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_SUCCESS, /*destLevel*/ LEVEL_CASTLE,   /*destArea*/ 0x01, /*destNode*/ WARP_NODE_24,  /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ WARP_NODE_DEATH,   /*destLevel*/ LEVEL_BITDW,    /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0C,  /*flags*/ WARP_NO_CHECKPOINT),
