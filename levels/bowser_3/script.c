...
const LevelScript level_bowser_3_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_3_geo_000398),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 1307, 0, /*angle*/ 0, 183, 0, /*behParam*/ BHV_PARAM_2(WARP_NODE_0A), /*beh*/ bhvSpinAirborneCircleWarp),
        WARP_NODE(/*id*/ WARP_NODE_0A,    /*destLevel*/ LEVEL_BOWSER_3, /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
        JUMP_LINK(script_func_local_1),
        WARP_NODE(/*id*/ WARP_NODE_DEATH, /*destLevel*/ LEVEL_BITS,     /*destArea*/ 0x01, /*destNode*/ WARP_NODE_0C, /*flags*/ WARP_NO_CHECKPOINT),
