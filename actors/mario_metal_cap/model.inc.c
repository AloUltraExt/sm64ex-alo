Gfx mario_metal_cap_metal_shade_ci8_aligner[] = {gsSPEndDisplayList()};
u8 mario_metal_cap_metal_shade_ci8[] = {
...
Gfx mario_metal_cap_metal_shade_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 mario_metal_cap_metal_shade_pal_rgba16[] = {
...
Vtx mario_metal_cap_Metal_Cap_mesh_layer_1_vtx_0[88] = {
...
Gfx mario_metal_cap_Metal_Cap_mesh_layer_1_tri_0[] = {
	gsSPVertex(mario_metal_cap_Metal_Cap_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(mario_metal_cap_Metal_Cap_mesh_layer_1_vtx_0 + 32, 32, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 2, 1, 0),
	...
	gsSPVertex(mario_metal_cap_Metal_Cap_mesh_layer_1_vtx_0 + 64, 24, 0),
...
Gfx mat_mario_metal_cap_metal[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT),
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsSPTexture(1984, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, mario_metal_cap_metal_shade_pal_rgba16),
	gsDPSetTile(0, 0, 0, 256, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadTLUTCmd(5, 100),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b_LOAD_BLOCK, 1, mario_metal_cap_metal_shade_ci8),
...
Gfx mat_revert_mario_metal_cap_metal[] = {
	gsDPPipeSync(),
...
Gfx mario_metal_cap_Metal_Cap_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_metal_cap_metal),
	gsSPDisplayList(mario_metal_cap_Metal_Cap_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_metal_cap_metal),
	gsDPPipeSync(),
