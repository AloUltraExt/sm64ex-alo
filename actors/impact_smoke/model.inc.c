...
#else
    gsDPLoadTextureBlock(impact_smoke_seg6_texture_0605AA28, G_IM_FMT_IA, G_IM_SIZ_16b, 64, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
#endif
...
#else
    gsDPLoadTextureBlock(impact_smoke_seg6_texture_0605CA28, G_IM_FMT_IA, G_IM_SIZ_16b, 64, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
#endif
    gsSPVertex(impact_smoke_seg6_vertex_06062A28, 8, 0),
    gsSPDisplayList(impact_smoke_seg6_dl_06062AD8),
#ifdef TARGET_N64
...
#else
    gsDPLoadTextureBlock(impact_smoke_seg6_texture_0605EA28, G_IM_FMT_IA, G_IM_SIZ_16b, 64, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
#endif
    gsSPVertex(impact_smoke_seg6_vertex_06062A28, 8, 0),
    gsSPDisplayList(impact_smoke_seg6_dl_06062AD8),
#ifdef TARGET_N64
...
#else
    gsDPLoadTextureBlock(impact_smoke_seg6_texture_06060A28, G_IM_FMT_IA, G_IM_SIZ_16b, 64, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
#endif
    gsSPVertex(impact_smoke_seg6_vertex_06062A28, 8, 0),
    gsSPDisplayList(impact_smoke_seg6_dl_06062AD8),
#ifdef TARGET_N64
